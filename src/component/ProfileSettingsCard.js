    ...
    >
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
        <Box sx={{ display: "flex", gap: 3, flexDirection: { xs: "column", md: "row" } }}>
          <TextField fullWidth label="Full Name" sx={fieldStyle} />
          <TextField fullWidth label="Email Address" sx={fieldStyle} />
        </Box>

        <Box sx={{ display: "flex", gap: 3, flexDirection: { xs: "column", md: "row" } }}>
          <TextField fullWidth label="Phone Number" sx={fieldStyle} />
          <TextField fullWidth label="Age" sx={fieldStyle} />
        </Box>

        <TextField fullWidth label="Language" sx={fieldStyle} />
        <TextField fullWidth multiline rows={4} label="Bio" sx={fieldStyle} />
